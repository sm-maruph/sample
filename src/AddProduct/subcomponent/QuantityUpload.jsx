...
const QuantityUpload = ({ info, setInfo }) => {
    const [play, { stop }] = useSound("../../../Sounds/ponnerporiman.mp3", {
        volume: 1,
        soundEnabled: true,
      });
  ...
  const handleQuantityChange = (e) => {
    setInfo({
      ...info,
      quantity: e.target.value, // Update the 'name' field in 'info'
    });
  };
  ...
  return (
    ...
    >
      ...
      <TextField
        label="পণ্যের পরিমাণ লিখুন"
        variant="outlined"
        sx={{ marginBottom: 3, width: '300px' }}
        value={info.quantity} // Bind the input value to 'info.name'
      ...
      <Link to="../priceupload" style={{ textDecoration: "none" }}>
      {/* Submit Button */}
        <Button
          variant="contained"
          color="primary"
